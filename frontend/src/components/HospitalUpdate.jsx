...
const UpdateHospital = () => {
  ...
  useEffect(() => {
    const fetchHospital = async () => {
      try {
        ...
        const res = await axios.get(`https://mernpep.onrender.com/api/v1/hospitals?id=${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`https://mernpep.onrender.com/api/v1/hospitals/update/${id}`, formData);
